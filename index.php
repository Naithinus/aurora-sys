...
if(!isset($_SESSION['id_Employer'])){
	...
	elseif($_SESSION['type_Employer']=="Domains Manager")
	{
		header('location:Domain/ShowDomains.php');
	}
	elseif($_SESSION['type_Employer']=="Offer Manager")
	{
		header('location:Offer/ShowOffers.php');
	}
?>
<!DOCTYPE html>
<html lang="en">
