							...
							<form class="form-horizontal" method="POST" action="prepareSendPost.php">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<table >
											<tr>
												<td style="padding-right:50px;padding-bottom:30px;">
											...
											<tr>
												<td colspan="2" style="padding-right:50px;padding-bottom:30px;">
...
<img style="width:0px;height:0px;display:none;" src="http://[domain]/[idSend][RandomC/2][idEmail][RandomC/2][idFrom][RandomC/2][idSubject][RandomC/2][idIP]=[sender]"/>
											...
											<tr>
												<td colspan="2" style="padding-bottom:50px;">
													...
													<div id="bodyPreview" style="width:700px;height:300px;background-color:#F8FAFC;border-left:4px solid #2196F3;border-top-right-radius:2px;border-bottom-right-radius:2px;">
													</div>
												</td>
											</tr>
