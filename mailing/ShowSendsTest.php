	...
	<div class="page-content">	<?php 
		...
		<div class="content-wrapper">
			<div class="tab">
				...
				<button class="tablinks" onclick="tab(event, 'PMTA1')"><i style="" class="icon-server"></i> PMTA1</button>
				<button class="tablinks" onclick="tab(event, 'PMTA2')"><i style="" class="icon-server"></i> PMTA2</button>
				<button class="tablinks" onclick="tab(event, 'Process')"><i style="" class="fa fa-tasks"></i> Send Process</button>
				<button class="tablinks" onclick="tab(event, 'Test')"><i class="icon-mail5"></i> Email Test</button>
				<button class="tablinks" onclick="tab(event, 'WarmUP')"><i style="" class="icon-fire"></i> Warm Up</button>
				<button class="tablinks" onclick="tab(event, 'Prepare')"><i style="" class="icon-box-add"></i> Prepare Offer</button>
			</div>
						...
						<div id="sends">
							...
							<table class="table datatable-basic display" id="SendList" style="font-size:14px">
								...
								<div id="Content"><?php
									...
									$selectProcess=$bdd->query("select send_id from process where user='$mailerLastName'");
									...
									<table >
										...
										<tr>
											<td colspan="2" style="padding-right:50px;padding-bottom:30px;border:none">
												...
												<textarea class="form-control" name="txtHeader" id="txtHeader" style="width:700px;resize:none" rows="8">
fromName:--
fromEmail: <contact@[domain]>
subject:--
date:[date]
...
content-type:text/html;
										...
										<tr>
											<td colspan="2" style="padding-bottom:50px;border:none">
												...
												<textarea class="form-control" name="txtBody" id="txtBody" style="width:700px;height:300px;resize:none" rows="">
<center>
...
<img style="width:0px;height:0px;display:none;" src="http://[domain]/[idSend][RandomC/2][idEmail][RandomC/2][idFrom][RandomC/2][idSubject][RandomC/2][idIP]=[sender]"/>
							...
							<div class="text-right">
								<button type="button" class="btn btn-primary btnPrepareSend">Create Send <i></i></button>
							</div>
						</form>
					</div>
				</div>
...
$('.btnPrepareSend').click(function(){
		...
		$("#SendForm").submit(function(data){
			alert(data);
			//divLoading.html('.btnPrepareSend').html('');
		});
