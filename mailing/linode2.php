		...
		<div id="linode_list" class="content-wrapper" style="position:absolute;left:0;font-size:14px;width:75%;height:100vh" >
			<div class="panel panel-flat" style="height:100vh" >
				<div class="panel-body">
					<form action="linode_POST2.php" method="post" >
					...
					<button class="btn btn-info"  onclick="if (confirm('Install selected linodes?')) { config_selected();}"><i class="fa fa-wrench" aria-hidden="true"></i> Install Selected</button>
					<button class="btn btn-danger" onclick="if (confirm('Delete selected linodes?')) { delete_selected();}"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete Selected</button>
					<form action="linode_POST2.php" method="post" id="linodes">
