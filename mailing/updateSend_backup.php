	...
	<div class="page-container">
		...
		<?php Include('../Includes/sidebar.php');?>
			...
			<div class="content-wrapper">
				                	...
				                	<!--<form action="#">-->
										...
										<div class="row">
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="form-group">
														<h2 class="panel-title"><u>URL Shortener</u></h2><br>
														<div class="col-lg-10">
															<div class="row">
																<div class="col-md-4">
																	<input type="text" class="form-control col-md-4"  id="link"  />
																</div>
																<div class="col-md-4">
																	<button type="button" class="btn btn-classic" onclick='Shortener()'>Shorten Link</button>
																</div>
																<div class="col-md-4" valign="center" id="newLink">
																</div>
																<script>
																	function Shortener()
																	{
																		...
																		if (!link) link="";
																		 $.post('ShortLinksPost.php',{link:link}, function( data ) {
																			document.getElementById('newLink').innerHTML = data;
																		});
																	}
																</script>
															</div>
				...
				<!-- Auto Response -->	
				<?php if(  ($_SESSION['id_Employer']==0)  or  ($_SESSION['id_Employer']==53)  or ($_SESSION['id_Employer']==56)  or($_SESSION['id_Employer']==54)   ):?>	
					<!-- Extra -->
					<div class="row">
						<div class="col-lg-12">
							<div class="panel panel-flat">
