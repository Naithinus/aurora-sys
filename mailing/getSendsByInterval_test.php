							    ...
							    while($row = $requete->fetch())
							    {
								   ...
								   if($requeteCount)
								   {
									...
									<tr>
										...
										<td><input type="text" class="form-control" style="width:70px;"/></td>
										<td><input type="text" class="form-control" style="width:70px;"/></td>
										<td><input type="text" class="form-control" style="width:70px;"/></td><td><span class="label bg-success-400">'.$countList.'</td>
										<td>				  
...
$('.btnSend').click(function(){
   ...
   var repeat   = $(this).parent().prev().prev().children().val();
  ...
  if(repeat=="")
   ...
   $.post('RealSend_test.php',{id_Send:idSend,fraction:Fraction,seed:Seed,xDelay:xDelay,repeat:repeat},function(data){
      alert(data);
